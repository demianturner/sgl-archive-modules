...
$words['password is %password%'] = 'Temporary password: %password%';
$words['%siteName% is cool'] = 'We hope you find %siteName% useful!';
$words['text about erroneous registration'] = 'If you didn\'t make this registration, or you\'re not interested in %siteName% after all, you can just ignore this email and we\'ll delete your sign-up data in the next few days.';
