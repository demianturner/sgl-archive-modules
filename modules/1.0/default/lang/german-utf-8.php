...
$defaultWords['The name of the module must be the exact name of the folder containing files, beware of case sensiveness'] = 'Der Name des Moduls muss der exakte Name des Verzeichnis des Moduls sein. Beachten Sie bitte die Gross- und Kleinschreibung';
...
$defaultWords['Words which system was unable to translate will be enclosed in "> <" marks'] = 'Wörter, die noch nicht übersetzt sind werden in spitzen Klammern (><) angezeigt';
...
$defaultWords['aMonths']['01'] =  'Januar';
$defaultWords['aMonths']['02'] =  'Februar';
$defaultWords['aMonths']['03'] =  'März';
