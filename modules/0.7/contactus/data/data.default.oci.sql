...
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusadminmgr_cmd_list', '', (SELECT MAX(module_id) FROM module));
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusadminmgr_cmd_view', '', (SELECT MAX(module_id) FROM module));
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusadminmgr_cmd_delete', '', (SELECT MAX(module_id) FROM module));
