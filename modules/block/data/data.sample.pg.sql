...
INSERT INTO block_assignment VALUES ((
    SELECT block_id FROM block WHERE name = 'Default_Block_SampleRight1'
    ), 0);
INSERT INTO block_assignment VALUES ((
    SELECT block_id FROM block WHERE name = 'Default_Block_Calendar'
    ), 0);
INSERT INTO block_assignment VALUES ((
    SELECT block_id FROM block WHERE name = 'User_Block_OnlineUsers'
    ), 0);
