...
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusadminmgr', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusadminmgr_cmd_list', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusadminmgr_cmd_view', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'contactusadminmgr_cmd_delete', '', @moduleId);
